...
// Actualizado: Agregado estado 'verificacion'
// =====================================================
...
const STATUS_ORDER: PolicyStatus[] = ['cotizacion', 'verificacion', 'activa', 'renovacion', 'renovada', 'vencida', 'no_renovada', 'inactiva', 'cancelada'];
...
const STATUS_COLORS: Record<PolicyStatus, { bg: string; text: string; border: string }> = {
  ...
  verificacion: { bg: 'bg-amber-100', text: 'text-amber-800', border: 'border-amber-500' },
