-- =====================================================
-- MIGRACIÓN: Módulo 01 - Gestión de Clientes y Pólizas
-- CRM Multi-tenant para Agencias de Seguros
-- =====================================================
-- NOTA: Este script asume que ya se ejecutó 00000_foundation.sql
-- Si no, las dependencias como 'tenants', 'users' deben existir.
-- =====================================================
...
-- (Si no existe del Módulo 00, la creamos)
-- =====================================================
